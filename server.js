...
io.on('connection', function(socket){
  ...
  socket.on('message eval', function(msg){
    ...
    switch (true) {
      default:
        break;
      case msg.substring(0,6) == "/name ":
        var maxnamelength = 6+14;
        var new_name = msg.substring(6,Math.min(maxnamelength, msg.length));
  ...
  socket.on('publish message', function(){
     name = id2name.get(socket.id);
